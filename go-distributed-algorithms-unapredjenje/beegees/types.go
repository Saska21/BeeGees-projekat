...
import (
	"fmt" //koristiš za generisanje hash stringa

	"github.com/danilokacanski/da/week03_04_parallel/process" //process.ProcessID dolazi iz asistentovog kostura i predstavlja identitet čvora, koristimo tip koji je predvidjen za simulator
)
...
func (b *Block) Hash() string {
	return fmt.Sprintf("H%d_V%d", b.Height, b.View)
}
...
// NewViewMessage (Algorithm 3), zar ne bi trebalo da sadrzi i VoteREQ i VoteRESP poruke
