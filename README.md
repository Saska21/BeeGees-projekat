...
Bilo kojim putem, na kraju treba da dobiješ folder **`go-distributed-algorithms-main` (go-distributed-algorithms-unapredjenje)** na svom računaru — otvori ga u editoru (npr. VS Code).
